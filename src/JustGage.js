...
export default class JustGage extends Component {
	...
	render() {
		...
		var alpha = (1 - (this.props.value - this.props.min) / (this.props.max - this.props.min)) * Math.PI;
		var Ro = this.props.width / 2 - this.props.width / 10;
		var Ri = Ro - this.props.width / 6.666666666666667 * gws;
		...
		return (
				<svg height="100%" version="1.1" width="100%" xmlns="http://www.w3.org/2000/svg" style={{width: this.props.width, height: this.props.height, overflow: 'hidden', position: 'relative', left: -0.109375, top: -0.390625}}>
					...
					<path fill="#edebeb" stroke="none" d="M100,256L40,256A160,160,0,0,1,360,256L300,256A100,100,0,0,0,100,256Z" style={{"WebkitTapHighlightColor": "rgba(0, 0, 0, 0)"}} filter="url(#g3-inner-shadow)" />
					<path fill="#fe0400" stroke="none" d={path} style={{"WebkitTapHighlightColor": "rgba(0, 0, 0, 0)"}} filter="url(#g3-inner-shadow)" />
					<text x="200" y="49.23076923076923" text-anchor="middle" font="10px &quot;Arial&quot;" stroke="none" fill="#999999" style={{"WebkitTapHighlightColor": "rgba(0, 0, 0, 0)", textAnchor: "middle", fontStyle: "normal",fontVariant: "normal", fontWeight: 'bold', fontStretch: 'normal', fontSize: 32, lineHeight: 'normal', fontFamily: "Arial", fillOpacity: 1}}>
						<tspan dy="11.012019230769234" style={{"WebkitTapHighlightColor": "rgba(0, 0, 0, 0)"}}>{ this.props.label }</tspan>
					</text>
					<text x="200" y="228.57142857142858" text-anchor="middle" font="10px &quot;Arial&quot;" stroke="none" fill="#010101" style={{"WebkitTapHighlightColor": "rgba(0, 0, 0, 0)", textAnchor: "middle", fontStyle: "normal", fontVariant: "normal", fontWeight: 'bold', fontStretch: 'normal', fontSize: 50, lineHeight: 'normal', fontFamily: "Arial", fillOpacity: 1}} font-size="50px" font-weight="bold" font-family="Arial" fill-opacity="1">
						<tspan dy="17.008928571428584" style={{"WebkitTapHighlightColor": "rgba(0, 0, 0, 0)"}}>{ this.props.value }</tspan>
					</text>
					<text x="200" y="259.57142857142856" text-anchor="middle" font="10px &quot;Arial&quot;" stroke="none" fill="#b3b3b3" style={{"WebkitTapHighlightColor": "rgba(0, 0, 0, 0)", textAnchor: "middle", fontStyle: "normal",fontVariant: "normal", fontWeight: 'normal', fontStretch: 'normal', fontSize: 20, lineHeight: 'normal', fontFamily: "Arial", fillOpacity: 1}} font-size="20px" font-weight="normal" font-family="Arial" fill-opacity="1">
